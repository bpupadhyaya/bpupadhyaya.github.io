...
const releases = JSON.parse(fs.readFileSync('releases-chronotrack.json', 'utf8'));
...
<head>
    ...
    <title>Release Notes — ChronoTrack Health — EqualInformation</title>
    <meta name="description" content="ChronoTrack Health release history — what's new in each version of the chronic condition tracker app.">
    ...
    <div class="nav-inner">
        ...
        <ul class="nav-links">
            ...
            <li class="nav-dropdown">
                <a href="release-notes-chronotrack.html">Release Notes <span class="dropdown-arrow">&#9662;</span></a>
                <ul class="dropdown-menu">
                    ...
                    <li><a href="release-notes-chronotrack.html">ChronoTrack</a></li>
                </ul>
            </li>
            <li class="nav-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="privacy-chronotrack.html">ChronoTrack</a></li>
                </ul>
            </li>
            <li class="nav-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="support-chronotrack.html">Support ChronoTrack</a></li>
                </ul>
            </li>
        </ul>
...
<div class="hero hero-sub">
    ...
    <div class="hero-content">
        ...
        <p class="hero-subtitle">
            What's new in ChronoTrack Health — version history and milestones.
        </p>
    </div>
</div>
...
<div class="content-section">
    ...
    <div class="highlight-box">
        <p>ChronoTrack Health is under active development. This page documents each production release with what changed, what's new, and what to expect.</p>
    </div>
...
fs.writeFileSync('release-notes-chronotrack.html', html);
console.log('Generated release-notes-chronotrack.html from releases-chronotrack.json');
