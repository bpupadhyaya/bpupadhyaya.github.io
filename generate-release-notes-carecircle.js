...
const releases = JSON.parse(fs.readFileSync('releases-carecircle.json', 'utf8'));
...
<head>
    ...
    <title>Release Notes — CareCircle — EqualInformation</title>
    <meta name="description" content="CareCircle release history — what's new in each version of the caregiver coordination app for families.">
    ...
    <div class="nav-inner">
        ...
        <ul class="nav-links">
            ...
            <li class="nav-dropdown">
                <a href="release-notes-carecircle.html">Release Notes <span class="dropdown-arrow">&#9662;</span></a>
            ...
            <li class="nav-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="privacy-carecircle.html">CareCircle</a></li>
            ...
            <li class="nav-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="support-carecircle.html">Support CareCircle</a></li>
...
<div class="hero hero-sub">
    ...
    <div class="hero-content">
        ...
        <p class="hero-subtitle">
            What's new in CareCircle — version history and milestones.
        </p>
    </div>
</div>
...
<div class="content-section">
    ...
    <div class="highlight-box">
        <p>CareCircle is under active development. This page documents each production release with what changed, what's new, and what to expect.</p>
    </div>
...
fs.writeFileSync('release-notes-carecircle.html', html);
console.log('Generated release-notes-carecircle.html from releases-carecircle.json');
