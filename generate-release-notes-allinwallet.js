...
const releases = JSON.parse(fs.readFileSync('releases-allinwallet.json', 'utf8'));
...
<head>
    ...
    <title>Release Notes — AllIn Wallet — EqualInformation</title>
    <meta name="description" content="AllIn Wallet release history — what's new in each version of the non-custodial multi-chain crypto wallet.">
    ...
    <style>
        ...
        .release-tag.alpha { background: rgba(139, 92, 246, 0.15); color: #8b5cf6; }
...
<ul class="breadcrumb">
    ...
    <li><a href="index.html#apps">Apps</a></li>
    <li class="sep">/</li>
    <li class="current">AllIn Wallet Release Notes</li>
</ul>
...
<div class="content-section">
    ...
    <div class="highlight-box">
        <p>AllIn Wallet is a non-custodial multi-chain crypto wallet with Solana Seed Vault hardware key support. This page documents each production release.</p>
    </div>
...
fs.writeFileSync('release-notes-allinwallet.html', html);
console.log('Generated release-notes-allinwallet.html from releases-allinwallet.json');
