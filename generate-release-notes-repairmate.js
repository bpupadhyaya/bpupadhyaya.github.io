...
const releases = JSON.parse(fs.readFileSync('releases-repairmate.json', 'utf8'));
...
<head>
    ...
    <title>Release Notes — RepairMate — EqualInformation</title>
    <meta name="description" content="RepairMate release history — what's new in each version of the DIY home repair companion app.">
    ...
    <div class="nav-inner">
        ...
        <ul class="nav-links">
            ...
            <li class="nav-dropdown">
                <a href="release-notes-repairmate.html">Release Notes <span class="dropdown-arrow">&#9662;</span></a>
...
<div class="hero hero-sub">
    ...
    <div class="hero-content">
        ...
        <p class="hero-subtitle">
            What's new in RepairMate — version history and milestones.
        </p>
    </div>
</div>
...
<div class="content-section">
    ...
    <div class="highlight-box">
        <p>RepairMate is under active development. This page documents each production release with what changed, what's new, and what to expect.</p>
    </div>
...
fs.writeFileSync('release-notes-repairmate.html', html);
console.log('Generated release-notes-repairmate.html from releases-repairmate.json');
