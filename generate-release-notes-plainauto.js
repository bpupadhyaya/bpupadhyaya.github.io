...
const releases = JSON.parse(fs.readFileSync('releases-plainauto.json', 'utf8'));
...
<head>
    ...
    <title>Release Notes — PlainAuto — EqualInformation</title>
    <meta name="description" content="PlainAuto release history — what's new in each version of the vehicle maintenance reference app.">
    ...
    <div class="nav-inner">
        ...
        <ul class="nav-links">
            ...
            <li class="nav-dropdown">
                <a href="release-notes-plainauto.html">Release Notes <span class="dropdown-arrow">&#9662;</span></a>
                <ul class="dropdown-menu">
                    ...
                    <li><a href="release-notes-plaindental.html">PlainDental</a></li>
                    <li><a href="release-notes-carecircle.html">CareCircle</a></li>
                    <li><a href="release-notes-plainhealth.html">PlainHealth</a></li>
                    <li><a href="release-notes-repairmate.html">RepairMate</a></li>
                    <li><a href="release-notes-plainlaw.html">PlainLaw</a></li>
                    <li><a href="release-notes-plainauto.html">PlainAuto</a></li>
                </ul>
            </li>
            <li class="nav-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="privacy-plainauto.html">PlainAuto</a></li>
                </ul>
            </li>
            <li class="nav-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="support-plainauto.html">Support PlainAuto</a></li>
                </ul>
            </li>
        </ul>
...
<div class="hero hero-sub">
    ...
    <div class="hero-content">
        ...
        <p class="hero-subtitle">
            What's new in PlainAuto — version history and milestones.
        </p>
    </div>
</div>
...
<div class="content-section">
    ...
    <div class="highlight-box">
        <p>PlainAuto is under active development. This page documents each production release with what changed, what's new, and what to expect.</p>
    </div>
...
${entriesHtml}
    ...
    <p style="color: var(--text-muted); font-size: 13px; margin-top: 40px; text-align: center;">
        ...
        For feedback or questions, contact <a href="mailto:bpupadhyaya@equalinformation.com" style="color: var(--accent); text-decoration: none;">bpupadhyaya@equalinformation.com</a>
    </p>
...
fs.writeFileSync('release-notes-plainauto.html', html);
console.log('Generated release-notes-plainauto.html from releases-plainauto.json');
