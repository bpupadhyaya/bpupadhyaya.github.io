...
const releases = JSON.parse(fs.readFileSync('releases-plaindental.json', 'utf8'));
...
<head>
    ...
    <title>Release Notes — PlainDental — EqualInformation</title>
    <meta name="description" content="PlainDental release history — what's new in each version of the dental health education app.">
    ...
    <div class="nav-inner">
        ...
        <ul class="nav-links">
            ...
            <li class="nav-dropdown">
                <a href="release-notes-plaindental.html">Release Notes <span class="dropdown-arrow">&#9662;</span></a>
            ...
            <li class="nav-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="privacy-plaindental.html">PlainDental</a></li>
            ...
            <li class="nav-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="support-plaindental.html">Support PlainDental</a></li>
...
<div class="hero hero-sub">
    ...
    <div class="hero-content">
        ...
        <p class="hero-subtitle">
            What's new in PlainDental — version history and milestones.
        </p>
    </div>
</div>
...
<div class="content-section">
    ...
    <div class="highlight-box">
        <p>PlainDental is under active development. This page documents each production release with what changed, what's new, and what to expect.</p>
    </div>
...
fs.writeFileSync('release-notes-plaindental.html', html);
console.log('Generated release-notes-plaindental.html from releases-plaindental.json');
