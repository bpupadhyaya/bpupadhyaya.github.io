...
const releases = JSON.parse(fs.readFileSync('releases-sristi.json', 'utf8'));
...
<head>
    ...
    <title>Release Notes — Sristi — EqualInformation</title>
    <meta name="description" content="Sristi release history — what's new in each version of the personal life optimizer app.">
    ...
    <div class="nav-inner">
        ...
        <ul class="nav-links">
            ...
            <li class="nav-dropdown">
                <a href="release-notes-sristi.html">Release Notes <span class="dropdown-arrow">&#9662;</span></a>
                <ul class="dropdown-menu">
                    ...
                    <li><a href="release-notes-sristi.html">Sristi</a></li>
                </ul>
            </li>
            <li class="nav-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="privacy-sristi.html">Sristi</a></li>
                </ul>
            </li>
            <li class="nav-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="support-sristi.html">Support Sristi</a></li>
                </ul>
            </li>
        </ul>
...
<div class="hero hero-sub">
    ...
    <div class="hero-content">
        ...
        <p class="hero-subtitle">
            What's new in Sristi — version history and milestones.
        </p>
    </div>
</div>
...
<div class="content-section">
    ...
    <div class="highlight-box">
        <p>Sristi is under active development. This page documents each production release with what changed, what's new, and what to expect.</p>
    </div>
...
fs.writeFileSync('release-notes-sristi.html', html);
console.log('Generated release-notes-sristi.html from releases-sristi.json');
