...
const releases = JSON.parse(fs.readFileSync('releases-nutrisizepro.json', 'utf8'));
...
<head>
    ...
    <title>Release Notes — Nutrisize Pro — EqualInformation</title>
    <meta name="description" content="Nutrisize Pro release history — what's new in each version of the health intelligence app.">
    ...
    <div class="nav-inner">
        ...
        <ul class="nav-links">
            ...
            <li class="nav-dropdown">
                <a href="release-notes-nutrisizepro.html">Release Notes <span class="dropdown-arrow">&#9662;</span></a>
...
<div class="hero hero-sub">
    ...
    <div class="hero-content">
        ...
        <p class="hero-subtitle">
            What's new in Nutrisize Pro — version history and milestones.
        </p>
    </div>
</div>
...
<div class="content-section">
    ...
    <div class="highlight-box">
        <p>Nutrisize Pro is under active development. This page documents each production release with what changed, what's new, and what to expect.</p>
    </div>
...
fs.writeFileSync('release-notes-nutrisizepro.html', html);
console.log('Generated release-notes-nutrisizepro.html from releases-nutrisizepro.json');
