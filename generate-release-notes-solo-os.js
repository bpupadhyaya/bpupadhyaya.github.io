...
const releases = JSON.parse(fs.readFileSync('releases-solo-os.json', 'utf8'));
...
<head>
    ...
    <title>Release Notes — SoloOS — EqualInformation</title>
    <meta name="description" content="SoloOS release history — what's new in each version of the on-device AI business OS for solopreneurs.">
    ...
    <div class="nav-inner">
        ...
        <ul class="nav-links">
            ...
            <li class="nav-dropdown">
                <a href="release-notes-solo-os.html">Release Notes <span class="dropdown-arrow">&#9662;</span></a>
                <ul class="dropdown-menu">
                    ...
                    <li><a href="release-notes-solo-os.html">SoloOS</a></li>
                </ul>
            </li>
            <li class="nav-dropdown">
                <a href="privacy-solo-os.html">Privacy Policy <span class="dropdown-arrow">&#9662;</span></a>
                <ul class="dropdown-menu">
                    <li><a href="privacy.html">Overview</a></li>
                    <li><a href="privacy-solo-os.html">SoloOS</a></li>
                    <li><a href="privacy-zoel-ai.html">Zoel AI</a></li>
                </ul>
            </li>
            <li class="nav-dropdown">
                <a href="support-solo-os.html" class="nav-cta">Support <span class="dropdown-arrow">&#9662;</span></a>
                <ul class="dropdown-menu">
                    <li><a href="support.html">Overview</a></li>
                    <li><a href="support-solo-os.html">Support SoloOS</a></li>
...
<div class="hero hero-sub">
    ...
    <div class="hero-content">
        ...
        <p class="hero-subtitle">
            What's new in SoloOS — version history and milestones.
        </p>
    </div>
</div>
...
<div class="content-section">
    ...
    <div class="highlight-box">
        <p>SoloOS is under active development. This page documents each release with what changed, what's new, and what to expect. The app is not yet on the App Store or Google Play — beta access coming soon.</p>
    </div>
...
${entriesHtml}
    ...
    <p style="color: var(--text-muted); font-size: 13px; margin-top: 40px; text-align: center;">
        ...
        For feedback or questions, contact <a href="mailto:bpupadhyaya5@gmail.com" style="color: var(--accent); text-decoration: none;">bpupadhyaya5@gmail.com</a>
    </p>
...
fs.writeFileSync('release-notes-solo-os.html', html);
console.log('Generated release-notes-solo-os.html from releases-solo-os.json');
